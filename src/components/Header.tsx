...
import { faBars, faStream, faBlog, faBook, faInfoCircle } from '@fortawesome/free-solid-svg-icons';
    ...
    <header className="bg-gray-800 text-white p-4 flex justify-between items-center">
      <div className="flex items-center">
        <button className="md:hidden mr-4" onClick={toggleSidebar}>
          <FontAwesomeIcon icon={faStream} className="w-6 h-6 text-white" />
        </button>
      ...
      {menuOpen && (
        <div className="md:hidden absolute top-16 right-0 w-full bg-gray-800 text-white">
          <ul className="flex flex-col items-center space-y-4 p-4">
            <li>
              <Link to="/blog" className="hover:underline flex items-center" onClick={toggleMenu}>
                <FontAwesomeIcon icon={faBlog} className="mr-2" /> Blog
              </Link>
            </li>
            <li>
              <Link to="/docs" className="hover:underline flex items-center" onClick={toggleMenu}>
                <FontAwesomeIcon icon={faBook} className="mr-2" /> Docs
              </Link>
            </li>
            <li>
              <Link to="/about" className="hover:underline flex items-center" onClick={toggleMenu}>
                <FontAwesomeIcon icon={faInfoCircle} className="mr-2" /> About
              </Link>
            </li>
          </ul>
